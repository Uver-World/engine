use bevy::{prelude::Vec3, render::mesh::{Mesh, shape}};
...
pub fn shape_to_mesh(shape: &Shape) -> Mesh {
    match shape {
        ...
        Shape::Circle => Mesh::from(shape::Cylinder { height: 20.0, radius: 10.0, resolution: 10, segments: 10   }),
        Shape::Ball => Mesh::from(shape::UVSphere { radius: 10.0, sectors: 32, stacks: 16 }),
